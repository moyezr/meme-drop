...
const importerPath = path.join(rootDir, "backend", "scripts", "import-benchmark-cases.ts");
const productionBenchmarkPath = path.join(rootDir, "backend", "evals", "suggestion-benchmark.json");
